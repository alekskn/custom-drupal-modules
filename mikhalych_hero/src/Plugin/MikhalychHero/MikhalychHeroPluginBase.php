...
/**
 * The base for all MikhalychHero plugins.
 */
abstract class MikhalychHeroPluginBase extends PluginBase implements MikhalychHeroPluginInterface, ContainerFactoryPluginInterface {
  ...
  /**
   * MikhalychHeroPluginBase constructor.
   *
  ...
  public function __construct(
    array $configuration, $plugin_id, $plugin_definition, Request $request,
    CurrentRouteMatch $current_route_match, TitleResolverInterface $title_resolver,
