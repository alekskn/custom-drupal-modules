    ...
    if ($term instanceof TermInterface && $term->bundle() == 'tags') {
      if ($term->get('field_image')->isEmpty()) {
        ...
        if (!empty($last_blog_article_result)) {
          ...
          if ($last_blog_article->hasField('field_featured_image') && !$last_blog_article->get('field_featured_image')->isEmpty()) {
            /** @var \Drupal\media\MediaInterface $media */
            $media = $last_blog_article->get('field_featured_image')->entity;
