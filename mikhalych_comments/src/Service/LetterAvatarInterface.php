...
namespace Drupal\mikhalych_comments\Service;

/**
 * Interface LetterAvatar
 *
 * @package Drupal\mikhalych_comments\Service
 */
interface LetterAvatarInterface {
   ...
   *  The color which will be tested for contrast. Can be array with RGB colors or HEX color.
   * @param string $text_color_dart
   ...
   */
  public function getTextColor($color, $text_color_dart = '#000000', $text_color_light = '#FFFFFF');
