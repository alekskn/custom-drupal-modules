...
/**
 * Class for generating letter avatar.
 *
...
class LetterAvatar implements LetterAvatarInterface {
   ...
   * {@inheritDoc}
   *
   * @see https://github.com/discourse/discourse/blob/master/lib/letter_avatar.rb#L8
   */
  ...
  public function getTextColor($color, $text_color_dart = '#000000', $text_color_light = '#FFFFFF') {
    ...
    return $yiq >= 128 ? $text_color_dart : $text_color_light;
  }

  /**
   * {@inheritDoc}
   *
   * @see https://github.com/discourse/discourse/blob/master/lib/letter_avatar.rb#L124
   */
