...
interface BlogManagerInterface {
   ...
   *  The node object for wich search related posts.
   * @param int $limit
  ...
  /**
   * Gets related blog post with same tags (one of them must exists).
   *
   * @param \Drupal\node\NodeInterface $node
   *  The node object for wich search related posts.
   ...
   * @param int $max
   *  The max related posts trying to find.
